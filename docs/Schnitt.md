...
## Einleitung
Wenn deine Aufnahme beendet ist, kannst du jetzt mit dem Schnitt beginnen. In diesem Kapitel lernst du, wie aus deiner Aufnahme ungewollte Stellen ausschneidest und deinen Podcast mit Kapitelmarken versiehst.
...
Reaper schneidet [nicht-destruktiv](https://de.wikipedia.org/wiki/Nicht-destruktive_Bearbeitung). Das heißt, deine Audiodateien werden nicht direkt bearbeitet, sondern bleiben unverändert erhalten. Du kannst beim Schnitt also gar nichts falsch oder kaputt machen. Im Notfall einfach ein Backup einspielen oder wenn es ganz schlimm kommt, noch mal von vorne anfangen. Ultraschall macht seit der Version 5 alle 10 Minuten ein Backup deiner Projektdatei (nicht der Audiodateien) und speichert diese im Projektordner. Um diese wieder herzustellen, gehe wie folgt vor:

:::tip  Backup wieder herstellen
Wenn du diese Funktion jetzt brauchst, dann keine Panik. Ultraschall macht alle 10 Minuten ein Backup deines Projekts. Diese sind nach dem folgenden Schmea benannt: $Projektname-$Datum_$Stunden$Minuten Um dieses Backup wieder herzustellen, öffne dein Projekt in deinem Dateimanager und kopiere die Backup-Datei die du haben möchtest aus dem Ordner backup in das Projektverzeichnis eine Ebene höher. Am besten benennst du diese Datei dann wieder um und öffnest diese mit Reaper. Fertig.
:::

...
![StudioLink Track](https://raw.githubusercontent.com/Ultraschall/ultraschall-manual/main/assets/images/Aufnahme/studiolink_track.jpg?=150x)

**StudioLink Track einfügen:** *Über das Podcast-Menü kanns du eine StudioLink Spur einfügen*
...
Zusätzlich zum Browserfenster öffent sich ein Terminal Fenster.

![Windows Terminal Fenster](https://raw.githubusercontent.com/Ultraschall/ultraschall-manual/main/assets/images/Aufnahme/studiolink_konsole.png) **Windows Terminal Fenster:** *Das Terminalfenster nicht schließen, sonst funktioniert StuidoLink nicht*

:::caution Achtung
Das Terminalfenster bei Winwows darf nicht geschlossen werden. Anderfalls funktioniert StudioLink nicht. Du kannst dann weder jemanden anrugen, noch angefunden werden.
:::
<!-- @todo: Sebastian fragen, ob das immer noch so ist, bzw. ob sich das mit einer zukünstigen Version ändert? -->
...
![soundboard-track](https://raw.githubusercontent.com/Ultraschall/ultraschall-manual/main/assets/images/Aufnahme/insert-soundboard-track.png) **Soundboard einfügen:** Über das Podcast-Menü kannst du eine soundboard Spur einfügen
...
**Soundboard**: *So sieht ein gefülltes Soundboard aus*
